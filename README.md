...
| [SJTU ICS Calendar Sync](scripts/sjtu-ics/README.md) | `scripts/sjtu-ics/sjtu-ics.user.js` | Aggregate SJTU courses, exams, and calendar events into ICS and sync to GitHub Gist |
